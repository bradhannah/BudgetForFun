  ...
  <button class="section-header" on:click={toggle}>
    ...
    <div class="header-totals">
      ...
      <div class="total-column">
        ...
        <span class="total-value" class:positive={totalRemaining > 0} class:zero={totalRemaining === 0}>
      ...
      {:else}
        <div class="items-list">
          ...
          <div class="total-row">
            ...
            <span class="col-remaining" class:positive={totalRemaining > 0} class:zero={totalRemaining === 0}>
              {formatCurrency(totalRemaining)}
            </span>
          </div>
        </div>
